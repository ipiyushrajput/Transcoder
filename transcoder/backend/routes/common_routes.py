...
def _serialize_job(j: Job) -> dict:
    return {
        ...
        "s3_path": j.s3_path,
        "s3_cloudfront_domain": j.s3_cloudfront_domain,
        "local_path": j.local_path,
        "mediapackage_url": j.mediapackage_url,
        "mediapackage_user": j.mediapackage_user,
        "mediapackage_password": j.mediapackage_password,
        "rtmp_output_url": j.rtmp_output_url,
        "master_filename": j.master_filename,
        "segment_length": j.segment_length,
        "hls_playlist_type": j.hls_playlist_type,
        "hls_flags": j.hls_flags,
        "hls_list_size": j.hls_list_size,
        "preset": j.preset,
        "subtitle_url": j.subtitle_url,
        "subtitle_language": j.subtitle_language,
        "esam_enabled": j.esam_enabled,
        "esam_scc_xml": j.esam_scc_xml,
        "esam_mcc_xml": j.esam_mcc_xml,
